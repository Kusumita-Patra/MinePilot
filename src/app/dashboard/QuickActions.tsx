...
const ACTIONS = [
  { label: "New Inspection", icon: ClipboardPlus, tone: "text-blue-400 bg-blue-500/10" },
  { label: "New Violation", icon: ShieldAlert, tone: "text-red-400 bg-red-500/10" },
  { label: "Upload Document", icon: UploadCloud, tone: "text-emerald-400 bg-emerald-500/10" },
  { label: "Generate Report", icon: FileBarChart, tone: "text-purple-400 bg-purple-500/10" },
];
